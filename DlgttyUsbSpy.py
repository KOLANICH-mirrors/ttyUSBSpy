...
aboutText = _("""<p><b>ttyUSBSpy</b> decodes pcap files captured by por tcpdump\n
...
class AboutBox(wx.Dialog):
    def __init__(self):
        wx.Dialog.__init__(self, None, -1, "About ttyUSBViewer",
